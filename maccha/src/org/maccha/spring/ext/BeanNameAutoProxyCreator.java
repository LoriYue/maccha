...
public class BeanNameAutoProxyCreator extends AbstractAutoProxyCreator {
	...
	public void setExcludeBeanNames(String[] excludeBeanNames) {
		Assert.notEmpty(this.beanNames, "'beanNames' must not be empty");
		this.excludeBeanNames = new ArrayList(excludeBeanNames.length);
	...
	protected Object[] getAdvicesAndAdvisorsForBean(Class beanClass,
		...
		if (this.excludeBeanNames != null) {
			for (String excludeMappedName : this.excludeBeanNames) {
				if (isMatch(beanName, excludeMappedName)) {
					return DO_NOT_PROXY;
				}
			}
		}
