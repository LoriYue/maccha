...
public class SysConfirmExceptionTest extends TestCase{
	...
	public void testHandleExceptionStringThrowable() {
		...
		Throwable t = null;
		try {
			SysConfirmException.handleException("testHandleExceptionStringThrowable", new Throwable("testHandleExceptionStringThrowable"));
		} catch (Exception e) {
			t = e;
		}
		assertEquals(new Throwable("testHandleExceptionStringThrowable").toString(), t.getCause().toString());
		assertNotNull(t);
	    assertTrue(t instanceof SysConfirmException);
	...
	public void testHandleExceptionString() {
		Throwable t = null;
		try {
			SysConfirmException.handleException("testHandleExceptionString");
		} catch (Exception e) {
			t = e;
		}
	...
	public void testHandleMessageExceptionStringThrowable() {
		Throwable t = null;
		try {
			SysConfirmException.handleMessageException("testHandleMessageExceptionStringThrowable", new Throwable("testHandleMessageExceptionStringThrowable"));
		} catch (Exception e) {
			t = e;
		}
	...
	public void testHandleMessageExceptionString() {
		Throwable t = null;
		try {
			SysConfirmException.handleMessageException("testHandleMessageExceptionString");
		} catch (Exception e) {
			t = e;
		}
		assertEquals(null, t.getCause());
	...
	public void testHandleExceptionStringObjectArray() {
		...
		Throwable t = null;
		try {
			SysConfirmException.handleException("testHandleExceptionStringObjectArray", args);
		} catch (Exception e) {
			t = e;
		}
		assertEquals(null, t.getCause());
	...
	public void testHandleExceptionStringStringThrowable() {
		Throwable t = null;
		try {
			SysConfirmException.handleException("testHandleExceptionStringStringThrowableKey", "testHandleExceptionStringStringThrowableMessage", new Throwable("testHandleExceptionStringStringThrowable"));
		} catch (Exception e) {
			t = e;
		}
